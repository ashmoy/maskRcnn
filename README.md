...
- Available sample data for testing: [MN138.nii](https://github.com/ashmoy/maskRcnn/releases/tag/test_files/MN138.nii) , [MG_test_scan.nii.gz](https://github.com/Maxlo24/AMASSS_CBCT/releases/download/v1.0.1/MG_test_scan.nii.gz)
